...
const file_AuthUserAdminService_authuseradmin_proto_rawDesc = "" +
	"\n" +
	"(AuthUserAdminService/authuseradmin.proto\x12\rauthuseradmin\"O\n" +
	...
	"\n" +
	"error_type\x18\x03 \x01(\tR\terrorType2\x92\x19\n" +
	...
	"\tLoginUser\x12\x1f.authuseradmin.LoginUserRequest\x1a .authuseradmin.LoginUserResponse\x12W\n" +
