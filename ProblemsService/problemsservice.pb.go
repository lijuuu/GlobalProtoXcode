...
var file_ProblemsService_problemsservice_proto_msgTypes = make([]protoimpl.MessageInfo, 76)
var file_ProblemsService_problemsservice_proto_goTypes = []any{
	...
	(*GetTopKGlobalRequest)(nil),                           // 14: problems.GetTopKGlobalRequest
	(*GetTopKGlobalResponse)(nil),                          // 15: problems.GetTopKGlobalResponse
	(*GetTopKEntityRequest)(nil),                           // 16: problems.GetTopKEntityRequest
	(*GetTopKEntityResponse)(nil),                          // 17: problems.GetTopKEntityResponse
	(*GetUserRankRequest)(nil),                             // 18: problems.GetUserRankRequest
	(*GetUserRankResponse)(nil),                            // 19: problems.GetUserRankResponse
	(*GetLeaderboardDataRequest)(nil),                      // 20: problems.GetLeaderboardDataRequest
	(*GetLeaderboardDataResponse)(nil),                     // 21: problems.GetLeaderboardDataResponse
	(*UserScore)(nil),                                      // 22: problems.UserScore
	(*GetMonthlyActivityHeatmapRequest)(nil),               // 23: problems.GetMonthlyActivityHeatmapRequest
	(*ActivityDay)(nil),                                    // 24: problems.ActivityDay
	(*GetMonthlyActivityHeatmapResponse)(nil),              // 25: problems.GetMonthlyActivityHeatmapResponse
	(*GetLeaderBoardOptionalCountryRequest)(nil),           // 26: problems.GetLeaderBoardOptionalCountryRequest
	(*GetLeaderBoardOptionalCountryResponse)(nil),          // 27: problems.GetLeaderBoardOptionalCountryResponse
	(*LeaderboardSingle)(nil),                              // 28: problems.LeaderboardSingle
	(*GetProblemsDoneStatisticsRequest)(nil),               // 29: problems.GetProblemsDoneStatisticsRequest
	(*GetProblemsDoneStatisticsResponse)(nil),              // 30: problems.GetProblemsDoneStatisticsResponse
	(*ProblemsDoneStatistics)(nil),                         // 31: problems.ProblemsDoneStatistics
	(*Timestamp)(nil),                                      // 32: problems.Timestamp
	(*TestCase)(nil),                                       // 33: problems.TestCase
	(*TestCases)(nil),                                      // 34: problems.TestCases
	(*TestCaseRunOnly)(nil),                                // 35: problems.TestCaseRunOnly
	(*ValidationCode)(nil),                                 // 36: problems.ValidationCode
	(*CreateProblemRequest)(nil),                           // 37: problems.CreateProblemRequest
	(*UpdateProblemRequest)(nil),                           // 38: problems.UpdateProblemRequest
	(*DeleteProblemRequest)(nil),                           // 39: problems.DeleteProblemRequest
	(*GetProblemRequest)(nil),                              // 40: problems.GetProblemRequest
	(*ListProblemsRequest)(nil),                            // 41: problems.ListProblemsRequest
	(*AddTestCasesRequest)(nil),                            // 42: problems.AddTestCasesRequest
	(*AddLanguageSupportRequest)(nil),                      // 43: problems.AddLanguageSupportRequest
	(*UpdateLanguageSupportRequest)(nil),                   // 44: problems.UpdateLanguageSupportRequest
	(*RemoveLanguageSupportRequest)(nil),                   // 45: problems.RemoveLanguageSupportRequest
	(*Problem)(nil),                                        // 46: problems.Problem
	(*CreateProblemResponse)(nil),                          // 47: problems.CreateProblemResponse
	(*UpdateProblemResponse)(nil),                          // 48: problems.UpdateProblemResponse
	(*DeleteProblemResponse)(nil),                          // 49: problems.DeleteProblemResponse
	(*GetProblemResponse)(nil),                             // 50: problems.GetProblemResponse
	(*ListProblemsResponse)(nil),                           // 51: problems.ListProblemsResponse
	(*AddTestCasesResponse)(nil),                           // 52: problems.AddTestCasesResponse
	(*AddLanguageSupportResponse)(nil),                     // 53: problems.AddLanguageSupportResponse
	(*UpdateLanguageSupportResponse)(nil),                  // 54: problems.UpdateLanguageSupportResponse
	(*RemoveLanguageSupportResponse)(nil),                  // 55: problems.RemoveLanguageSupportResponse
	(*DeleteTestCaseRequest)(nil),                          // 56: problems.DeleteTestCaseRequest
	(*DeleteTestCaseResponse)(nil),                         // 57: problems.DeleteTestCaseResponse
	(*GetLanguageSupportsRequest)(nil),                     // 58: problems.GetLanguageSupportsRequest
	(*GetLanguageSupportsResponse)(nil),                    // 59: problems.GetLanguageSupportsResponse
	(*FullValidationByProblemIDRequest)(nil),               // 60: problems.FullValidationByProblemIDRequest
	(*FullValidationByProblemIDResponse)(nil),              // 61: problems.FullValidationByProblemIDResponse
	(*RunProblemRequest)(nil),                              // 62: problems.RunProblemRequest
	(*RunProblemResponse)(nil),                             // 63: problems.RunProblemResponse
	(*Submission)(nil),                                     // 64: problems.Submission
	(*GetSubmissionsRequest)(nil),                          // 65: problems.GetSubmissionsRequest
	(*GetSubmissionsResponse)(nil),                         // 66: problems.GetSubmissionsResponse
	(*GetProblemByIdSlugRequest)(nil),                      // 67: problems.GetProblemByIdSlugRequest
	(*GetProblemByIdSlugResponse)(nil),                     // 68: problems.GetProblemByIdSlugResponse
	(*GetProblemMetadataListRequest)(nil),                  // 69: problems.GetProblemMetadataListRequest
	(*GetProblemMetadataListResponse)(nil),                 // 70: problems.GetProblemMetadataListResponse
	(*ProblemMetadataLite)(nil),                            // 71: problems.ProblemMetadataLite
	nil,                                                    // 72: problems.VerifyProblemExistenceBulkResponse.ProblemExistenceEntry
	nil,                                                    // 73: problems.Problem.ValidateCodeEntry
	nil,                                                    // 74: problems.GetLanguageSupportsResponse.ValidateCodeEntry
	nil,                                                    // 75: problems.ProblemMetadataLite.PlaceholderMapsEntry
}
var file_ProblemsService_problemsservice_proto_depIdxs = []int32{
	...
	72, // 2: problems.VerifyProblemExistenceBulkResponse.problem_existence:type_name -> problems.VerifyProblemExistenceBulkResponse.ProblemExistenceEntry
	64, // 3: problems.GetSubmissionsByIDResponse.submission:type_name -> problems.Submission
	13, // 4: problems.GetBulkProblemMetadataResponse.BulkProblemMetadata:type_name -> problems.BulkProblemMetadata
	22, // 5: problems.GetTopKGlobalResponse.users:type_name -> problems.UserScore
	22, // 6: problems.GetTopKEntityResponse.users:type_name -> problems.UserScore
	22, // 7: problems.GetLeaderboardDataResponse.top_k_global:type_name -> problems.UserScore
	22, // 8: problems.GetLeaderboardDataResponse.top_k_entity:type_name -> problems.UserScore
	24, // 9: problems.GetMonthlyActivityHeatmapResponse.data:type_name -> problems.ActivityDay
	28, // 10: problems.GetLeaderBoardOptionalCountryResponse.data:type_name -> problems.LeaderboardSingle
	31, // 11: problems.GetProblemsDoneStatisticsResponse.data:type_name -> problems.ProblemsDoneStatistics
	33, // 12: problems.TestCases.run:type_name -> problems.TestCase
	33, // 13: problems.TestCases.submit:type_name -> problems.TestCase
	33, // 14: problems.TestCaseRunOnly.run:type_name -> problems.TestCase
	34, // 15: problems.AddTestCasesRequest.testcases:type_name -> problems.TestCases
	36, // 16: problems.AddLanguageSupportRequest.validation_code:type_name -> problems.ValidationCode
	36, // 17: problems.UpdateLanguageSupportRequest.validation_code:type_name -> problems.ValidationCode
	32, // 18: problems.Problem.created_at:type_name -> problems.Timestamp
	32, // 19: problems.Problem.updated_at:type_name -> problems.Timestamp
	32, // 20: problems.Problem.deleted_at:type_name -> problems.Timestamp
	34, // 21: problems.Problem.testcases:type_name -> problems.TestCases
	73, // 22: problems.Problem.validate_code:type_name -> problems.Problem.ValidateCodeEntry
	32, // 23: problems.Problem.validated_at:type_name -> problems.Timestamp
	46, // 24: problems.GetProblemResponse.problem:type_name -> problems.Problem
	46, // 25: problems.ListProblemsResponse.problems:type_name -> problems.Problem
	74, // 26: problems.GetLanguageSupportsResponse.validate_code:type_name -> problems.GetLanguageSupportsResponse.ValidateCodeEntry
	32, // 27: problems.Submission.submitted_at:type_name -> problems.Timestamp
	64, // 28: problems.GetSubmissionsResponse.submissions:type_name -> problems.Submission
	71, // 29: problems.GetProblemByIdSlugResponse.problemmetdata:type_name -> problems.ProblemMetadataLite
	71, // 30: problems.GetProblemMetadataListResponse.problemmetdata:type_name -> problems.ProblemMetadataLite
	35, // 31: problems.ProblemMetadataLite.testcase_run:type_name -> problems.TestCaseRunOnly
	75, // 32: problems.ProblemMetadataLite.placeholder_maps:type_name -> problems.ProblemMetadataLite.PlaceholderMapsEntry
	36, // 33: problems.Problem.ValidateCodeEntry.value:type_name -> problems.ValidationCode
	36, // 34: problems.GetLanguageSupportsResponse.ValidateCodeEntry.value:type_name -> problems.ValidationCode
	37, // 35: problems.ProblemsService.CreateProblem:input_type -> problems.CreateProblemRequest
	38, // 36: problems.ProblemsService.UpdateProblem:input_type -> problems.UpdateProblemRequest
	39, // 37: problems.ProblemsService.DeleteProblem:input_type -> problems.DeleteProblemRequest
	40, // 38: problems.ProblemsService.GetProblem:input_type -> problems.GetProblemRequest
	41, // 39: problems.ProblemsService.ListProblems:input_type -> problems.ListProblemsRequest
	67, // 40: problems.ProblemsService.GetProblemByIDSlug:input_type -> problems.GetProblemByIdSlugRequest
	69, // 41: problems.ProblemsService.GetProblemMetadataList:input_type -> problems.GetProblemMetadataListRequest
	42, // 42: problems.ProblemsService.AddTestCases:input_type -> problems.AddTestCasesRequest
	56, // 43: problems.ProblemsService.DeleteTestCase:input_type -> problems.DeleteTestCaseRequest
	58, // 44: problems.ProblemsService.GetLanguageSupports:input_type -> problems.GetLanguageSupportsRequest
	43, // 45: problems.ProblemsService.AddLanguageSupport:input_type -> problems.AddLanguageSupportRequest
	44, // 46: problems.ProblemsService.UpdateLanguageSupport:input_type -> problems.UpdateLanguageSupportRequest
	45, // 47: problems.ProblemsService.RemoveLanguageSupport:input_type -> problems.RemoveLanguageSupportRequest
	60, // 48: problems.ProblemsService.FullValidationByProblemID:input_type -> problems.FullValidationByProblemIDRequest
	62, // 49: problems.ProblemsService.RunUserCodeProblem:input_type -> problems.RunProblemRequest
	65, // 50: problems.ProblemsService.GetSubmissionsByOptionalProblemID:input_type -> problems.GetSubmissionsRequest
	7,  // 51: problems.ProblemsService.GetSubmissionsByID:input_type -> problems.GetSubmissionsByIDRequest
	29, // 52: problems.ProblemsService.GetProblemsDoneStatistics:input_type -> problems.GetProblemsDoneStatisticsRequest
	9,  // 53: problems.ProblemsService.ForceChangeUserEntityInSubmission:input_type -> problems.ForceChangeUserEntityInSubmissionRequest
	23, // 54: problems.ProblemsService.GetMonthlyActivityHeatmap:input_type -> problems.GetMonthlyActivityHeatmapRequest
	14, // 55: problems.ProblemsService.GetTopKGlobal:input_type -> problems.GetTopKGlobalRequest
	16, // 56: problems.ProblemsService.GetTopKEntity:input_type -> problems.GetTopKEntityRequest
	18, // 57: problems.ProblemsService.GetUserRank:input_type -> problems.GetUserRankRequest
	20, // 58: problems.ProblemsService.GetLeaderboardData:input_type -> problems.GetLeaderboardDataRequest
	11, // 59: problems.ProblemsService.GetBulkProblemMetadata:input_type -> problems.GetBulkProblemMetadataRequest
	3,  // 60: problems.ProblemsService.VerifyProblemExistenceBulk:input_type -> problems.VerifyProblemExistenceBulkRequest
	0,  // 61: problems.ProblemsService.RandomProblemIDsGenWithDifficultyRatio:input_type -> problems.RandomProblemIDsGenWithDifficultyRatioRequest
	5,  // 62: problems.ProblemsService.ProblemIDsDoneByUserID:input_type -> problems.ProblemIDsDoneByUserIDRequest
	47, // 63: problems.ProblemsService.CreateProblem:output_type -> problems.CreateProblemResponse
	48, // 64: problems.ProblemsService.UpdateProblem:output_type -> problems.UpdateProblemResponse
	49, // 65: problems.ProblemsService.DeleteProblem:output_type -> problems.DeleteProblemResponse
	50, // 66: problems.ProblemsService.GetProblem:output_type -> problems.GetProblemResponse
	51, // 67: problems.ProblemsService.ListProblems:output_type -> problems.ListProblemsResponse
	68, // 68: problems.ProblemsService.GetProblemByIDSlug:output_type -> problems.GetProblemByIdSlugResponse
	70, // 69: problems.ProblemsService.GetProblemMetadataList:output_type -> problems.GetProblemMetadataListResponse
	52, // 70: problems.ProblemsService.AddTestCases:output_type -> problems.AddTestCasesResponse
	57, // 71: problems.ProblemsService.DeleteTestCase:output_type -> problems.DeleteTestCaseResponse
	59, // 72: problems.ProblemsService.GetLanguageSupports:output_type -> problems.GetLanguageSupportsResponse
	53, // 73: problems.ProblemsService.AddLanguageSupport:output_type -> problems.AddLanguageSupportResponse
	54, // 74: problems.ProblemsService.UpdateLanguageSupport:output_type -> problems.UpdateLanguageSupportResponse
	55, // 75: problems.ProblemsService.RemoveLanguageSupport:output_type -> problems.RemoveLanguageSupportResponse
	61, // 76: problems.ProblemsService.FullValidationByProblemID:output_type -> problems.FullValidationByProblemIDResponse
	63, // 77: problems.ProblemsService.RunUserCodeProblem:output_type -> problems.RunProblemResponse
	66, // 78: problems.ProblemsService.GetSubmissionsByOptionalProblemID:output_type -> problems.GetSubmissionsResponse
	8,  // 79: problems.ProblemsService.GetSubmissionsByID:output_type -> problems.GetSubmissionsByIDResponse
	30, // 80: problems.ProblemsService.GetProblemsDoneStatistics:output_type -> problems.GetProblemsDoneStatisticsResponse
	10, // 81: problems.ProblemsService.ForceChangeUserEntityInSubmission:output_type -> problems.ForceChangeUserEntityInSubmissionResponse
	25, // 82: problems.ProblemsService.GetMonthlyActivityHeatmap:output_type -> problems.GetMonthlyActivityHeatmapResponse
	15, // 83: problems.ProblemsService.GetTopKGlobal:output_type -> problems.GetTopKGlobalResponse
	17, // 84: problems.ProblemsService.GetTopKEntity:output_type -> problems.GetTopKEntityResponse
	19, // 85: problems.ProblemsService.GetUserRank:output_type -> problems.GetUserRankResponse
	21, // 86: problems.ProblemsService.GetLeaderboardData:output_type -> problems.GetLeaderboardDataResponse
	12, // 87: problems.ProblemsService.GetBulkProblemMetadata:output_type -> problems.GetBulkProblemMetadataResponse
	4,  // 88: problems.ProblemsService.VerifyProblemExistenceBulk:output_type -> problems.VerifyProblemExistenceBulkResponse
	2,  // 89: problems.ProblemsService.RandomProblemIDsGenWithDifficultyRatio:output_type -> problems.RandomProblemIDsGenWithDifficultyRatioResponse
	6,  // 90: problems.ProblemsService.ProblemIDsDoneByUserID:output_type -> problems.ProblemIDsDoneByUserIDResponse
...
func file_ProblemsService_problemsservice_proto_init() {
	...
	file_ProblemsService_problemsservice_proto_msgTypes[26].OneofWrappers = []any{}
	...
	file_ProblemsService_problemsservice_proto_msgTypes[38].OneofWrappers = []any{}
