...
var file_ProblemsService_problemsservice_proto_msgTypes = make([]protoimpl.MessageInfo, 97)
var file_ProblemsService_problemsservice_proto_goTypes = []any{
	(*ForceChangeUserEntityInSubmissionRequest)(nil),  // 0: problems.ForceChangeUserEntityInSubmissionRequest
	(*ForceChangeUserEntityInSubmissionResponse)(nil), // 1: problems.ForceChangeUserEntityInSubmissionResponse
	(*GetBulkProblemMetadataRequest)(nil),             // 2: problems.GetBulkProblemMetadataRequest
	(*GetBulkProblemMetadataResponse)(nil),            // 3: problems.GetBulkProblemMetadataResponse
	(*BulkProblemMetadata)(nil),                       // 4: problems.BulkProblemMetadata
	(*GetChallengeHistoryRequest)(nil),                // 5: problems.GetChallengeHistoryRequest
	(*GetChallengeHistoryResponse)(nil),               // 6: problems.GetChallengeHistoryResponse
	(*Challenge)(nil),                                 // 7: problems.Challenge
	(*ProblemMetadata)(nil),                           // 8: problems.ProblemMetadata
	(*ChallengeProblemMetadata)(nil),                  // 9: problems.ChallengeProblemMetadata
	(*ProblemMetadataList)(nil),                       // 10: problems.ProblemMetadataList
	(*LeaderboardEntry)(nil),                          // 11: problems.LeaderboardEntry
	(*UserStats)(nil),                                 // 12: problems.UserStats
	(*ChallengeStat)(nil),                             // 13: problems.ChallengeStat
	(*CreateChallengeRequest)(nil),                    // 14: problems.CreateChallengeRequest
	(*CreateChallengeResponse)(nil),                   // 15: problems.CreateChallengeResponse
	(*GetChallengeDetailsRequest)(nil),                // 16: problems.GetChallengeDetailsRequest
	(*GetChallengeDetailsResponse)(nil),               // 17: problems.GetChallengeDetailsResponse
	(*GetPublicChallengesRequest)(nil),                // 18: problems.GetPublicChallengesRequest
	(*GetPublicChallengesResponse)(nil),               // 19: problems.GetPublicChallengesResponse
	(*JoinChallengeRequest)(nil),                      // 20: problems.JoinChallengeRequest
	(*JoinChallengeResponse)(nil),                     // 21: problems.JoinChallengeResponse
	(*StartChallengeRequest)(nil),                     // 22: problems.StartChallengeRequest
	(*StartChallengeResponse)(nil),                    // 23: problems.StartChallengeResponse
	(*EndChallengeRequest)(nil),                       // 24: problems.EndChallengeRequest
	(*EndChallengeResponse)(nil),                      // 25: problems.EndChallengeResponse
	(*GetSubmissionStatusRequest)(nil),                // 26: problems.GetSubmissionStatusRequest
	(*GetSubmissionStatusResponse)(nil),               // 27: problems.GetSubmissionStatusResponse
	(*GetChallengeSubmissionsRequest)(nil),            // 28: problems.GetChallengeSubmissionsRequest
	(*GetChallengeSubmissionsResponse)(nil),           // 29: problems.GetChallengeSubmissionsResponse
	(*GetUserStatsRequest)(nil),                       // 30: problems.GetUserStatsRequest
	(*GetUserStatsResponse)(nil),                      // 31: problems.GetUserStatsResponse
	(*GetChallengeUserStatsRequest)(nil),              // 32: problems.GetChallengeUserStatsRequest
	(*GetChallengeUserStatsResponse)(nil),             // 33: problems.GetChallengeUserStatsResponse
	(*GetTopKGlobalRequest)(nil),                      // 34: problems.GetTopKGlobalRequest
	(*GetTopKGlobalResponse)(nil),                     // 35: problems.GetTopKGlobalResponse
	(*GetTopKEntityRequest)(nil),                      // 36: problems.GetTopKEntityRequest
	(*GetTopKEntityResponse)(nil),                     // 37: problems.GetTopKEntityResponse
	(*GetUserRankRequest)(nil),                        // 38: problems.GetUserRankRequest
	(*GetUserRankResponse)(nil),                       // 39: problems.GetUserRankResponse
	(*GetLeaderboardDataRequest)(nil),                 // 40: problems.GetLeaderboardDataRequest
	(*GetLeaderboardDataResponse)(nil),                // 41: problems.GetLeaderboardDataResponse
	(*UserScore)(nil),                                 // 42: problems.UserScore
	(*GetMonthlyActivityHeatmapRequest)(nil),          // 43: problems.GetMonthlyActivityHeatmapRequest
	(*ActivityDay)(nil),                               // 44: problems.ActivityDay
	(*GetMonthlyActivityHeatmapResponse)(nil),         // 45: problems.GetMonthlyActivityHeatmapResponse
	(*GetLeaderBoardOptionalCountryRequest)(nil),      // 46: problems.GetLeaderBoardOptionalCountryRequest
	(*GetLeaderBoardOptionalCountryResponse)(nil),     // 47: problems.GetLeaderBoardOptionalCountryResponse
	(*LeaderboardSingle)(nil),                         // 48: problems.LeaderboardSingle
	(*GetProblemsDoneStatisticsRequest)(nil),          // 49: problems.GetProblemsDoneStatisticsRequest
	(*GetProblemsDoneStatisticsResponse)(nil),         // 50: problems.GetProblemsDoneStatisticsResponse
	(*ProblemsDoneStatistics)(nil),                    // 51: problems.ProblemsDoneStatistics
	(*Timestamp)(nil),                                 // 52: problems.Timestamp
	(*TestCase)(nil),                                  // 53: problems.TestCase
	(*TestCases)(nil),                                 // 54: problems.TestCases
	(*TestCaseRunOnly)(nil),                           // 55: problems.TestCaseRunOnly
	(*ValidationCode)(nil),                            // 56: problems.ValidationCode
	(*CreateProblemRequest)(nil),                      // 57: problems.CreateProblemRequest
	(*UpdateProblemRequest)(nil),                      // 58: problems.UpdateProblemRequest
	(*DeleteProblemRequest)(nil),                      // 59: problems.DeleteProblemRequest
	(*GetProblemRequest)(nil),                         // 60: problems.GetProblemRequest
	(*ListProblemsRequest)(nil),                       // 61: problems.ListProblemsRequest
	(*AddTestCasesRequest)(nil),                       // 62: problems.AddTestCasesRequest
	(*AddLanguageSupportRequest)(nil),                 // 63: problems.AddLanguageSupportRequest
	(*UpdateLanguageSupportRequest)(nil),              // 64: problems.UpdateLanguageSupportRequest
	(*RemoveLanguageSupportRequest)(nil),              // 65: problems.RemoveLanguageSupportRequest
	(*Problem)(nil),                                   // 66: problems.Problem
	(*CreateProblemResponse)(nil),                     // 67: problems.CreateProblemResponse
	(*UpdateProblemResponse)(nil),                     // 68: problems.UpdateProblemResponse
	(*DeleteProblemResponse)(nil),                     // 69: problems.DeleteProblemResponse
	(*GetProblemResponse)(nil),                        // 70: problems.GetProblemResponse
	(*ListProblemsResponse)(nil),                      // 71: problems.ListProblemsResponse
	(*AddTestCasesResponse)(nil),                      // 72: problems.AddTestCasesResponse
	(*AddLanguageSupportResponse)(nil),                // 73: problems.AddLanguageSupportResponse
	(*UpdateLanguageSupportResponse)(nil),             // 74: problems.UpdateLanguageSupportResponse
	(*RemoveLanguageSupportResponse)(nil),             // 75: problems.RemoveLanguageSupportResponse
	(*DeleteTestCaseRequest)(nil),                     // 76: problems.DeleteTestCaseRequest
	(*DeleteTestCaseResponse)(nil),                    // 77: problems.DeleteTestCaseResponse
	(*GetLanguageSupportsRequest)(nil),                // 78: problems.GetLanguageSupportsRequest
	(*GetLanguageSupportsResponse)(nil),               // 79: problems.GetLanguageSupportsResponse
	(*FullValidationByProblemIDRequest)(nil),          // 80: problems.FullValidationByProblemIDRequest
	(*FullValidationByProblemIDResponse)(nil),         // 81: problems.FullValidationByProblemIDResponse
	(*RunProblemRequest)(nil),                         // 82: problems.RunProblemRequest
	(*RunProblemResponse)(nil),                        // 83: problems.RunProblemResponse
	(*Submission)(nil),                                // 84: problems.Submission
	(*GetSubmissionsRequest)(nil),                     // 85: problems.GetSubmissionsRequest
	(*GetSubmissionsResponse)(nil),                    // 86: problems.GetSubmissionsResponse
	(*GetProblemByIdSlugRequest)(nil),                 // 87: problems.GetProblemByIdSlugRequest
	(*GetProblemByIdSlugResponse)(nil),                // 88: problems.GetProblemByIdSlugResponse
	(*GetProblemMetadataListRequest)(nil),             // 89: problems.GetProblemMetadataListRequest
	(*GetProblemMetadataListResponse)(nil),            // 90: problems.GetProblemMetadataListResponse
	(*ProblemMetadataLite)(nil),                       // 91: problems.ProblemMetadataLite
	nil,                                               // 92: problems.Challenge.UserProblemMetadataEntry
	nil,                                               // 93: problems.UserStats.ChallengeStatsEntry
	nil,                                               // 94: problems.Problem.ValidateCodeEntry
	nil,                                               // 95: problems.GetLanguageSupportsResponse.ValidateCodeEntry
	nil,                                               // 96: problems.ProblemMetadataLite.PlaceholderMapsEntry
}
var file_ProblemsService_problemsservice_proto_depIdxs = []int32{
	4,  // 0: problems.GetBulkProblemMetadataResponse.BulkProblemMetadata:type_name -> problems.BulkProblemMetadata
	7,  // 1: problems.GetChallengeHistoryResponse.challenges:type_name -> problems.Challenge
	92, // 2: problems.Challenge.user_problem_metadata:type_name -> problems.Challenge.UserProblemMetadataEntry
	55, // 3: problems.ProblemMetadata.testcase_run:type_name -> problems.TestCaseRunOnly
	9,  // 4: problems.ProblemMetadataList.challenge_problem_metadata:type_name -> problems.ChallengeProblemMetadata
	93, // 5: problems.UserStats.challenge_stats:type_name -> problems.UserStats.ChallengeStatsEntry
	7,  // 6: problems.GetChallengeDetailsResponse.challenge:type_name -> problems.Challenge
	11, // 7: problems.GetChallengeDetailsResponse.leaderboard:type_name -> problems.LeaderboardEntry
	7,  // 8: problems.GetPublicChallengesResponse.challenges:type_name -> problems.Challenge
	11, // 9: problems.EndChallengeResponse.leaderboard:type_name -> problems.LeaderboardEntry
	84, // 10: problems.GetSubmissionStatusResponse.submission:type_name -> problems.Submission
	84, // 11: problems.GetChallengeSubmissionsResponse.submissions:type_name -> problems.Submission
	12, // 12: problems.GetUserStatsResponse.stats:type_name -> problems.UserStats
	9,  // 13: problems.GetChallengeUserStatsResponse.challenge_problem_metadata:type_name -> problems.ChallengeProblemMetadata
	42, // 14: problems.GetTopKGlobalResponse.users:type_name -> problems.UserScore
	42, // 15: problems.GetTopKEntityResponse.users:type_name -> problems.UserScore
	42, // 16: problems.GetLeaderboardDataResponse.top_k_global:type_name -> problems.UserScore
	42, // 17: problems.GetLeaderboardDataResponse.top_k_entity:type_name -> problems.UserScore
	44, // 18: problems.GetMonthlyActivityHeatmapResponse.data:type_name -> problems.ActivityDay
	48, // 19: problems.GetLeaderBoardOptionalCountryResponse.data:type_name -> problems.LeaderboardSingle
	51, // 20: problems.GetProblemsDoneStatisticsResponse.data:type_name -> problems.ProblemsDoneStatistics
	53, // 21: problems.TestCases.run:type_name -> problems.TestCase
	53, // 22: problems.TestCases.submit:type_name -> problems.TestCase
	53, // 23: problems.TestCaseRunOnly.run:type_name -> problems.TestCase
	54, // 24: problems.AddTestCasesRequest.testcases:type_name -> problems.TestCases
	56, // 25: problems.AddLanguageSupportRequest.validation_code:type_name -> problems.ValidationCode
	56, // 26: problems.UpdateLanguageSupportRequest.validation_code:type_name -> problems.ValidationCode
	52, // 27: problems.Problem.created_at:type_name -> problems.Timestamp
	52, // 28: problems.Problem.updated_at:type_name -> problems.Timestamp
	52, // 29: problems.Problem.deleted_at:type_name -> problems.Timestamp
	54, // 30: problems.Problem.testcases:type_name -> problems.TestCases
	94, // 31: problems.Problem.validate_code:type_name -> problems.Problem.ValidateCodeEntry
	52, // 32: problems.Problem.validated_at:type_name -> problems.Timestamp
	66, // 33: problems.GetProblemResponse.problem:type_name -> problems.Problem
	66, // 34: problems.ListProblemsResponse.problems:type_name -> problems.Problem
	95, // 35: problems.GetLanguageSupportsResponse.validate_code:type_name -> problems.GetLanguageSupportsResponse.ValidateCodeEntry
	52, // 36: problems.Submission.submitted_at:type_name -> problems.Timestamp
	84, // 37: problems.GetSubmissionsResponse.submissions:type_name -> problems.Submission
	91, // 38: problems.GetProblemByIdSlugResponse.problemmetdata:type_name -> problems.ProblemMetadataLite
	91, // 39: problems.GetProblemMetadataListResponse.problemmetdata:type_name -> problems.ProblemMetadataLite
	55, // 40: problems.ProblemMetadataLite.testcase_run:type_name -> problems.TestCaseRunOnly
	96, // 41: problems.ProblemMetadataLite.placeholder_maps:type_name -> problems.ProblemMetadataLite.PlaceholderMapsEntry
	10, // 42: problems.Challenge.UserProblemMetadataEntry.value:type_name -> problems.ProblemMetadataList
	13, // 43: problems.UserStats.ChallengeStatsEntry.value:type_name -> problems.ChallengeStat
	56, // 44: problems.Problem.ValidateCodeEntry.value:type_name -> problems.ValidationCode
	56, // 45: problems.GetLanguageSupportsResponse.ValidateCodeEntry.value:type_name -> problems.ValidationCode
	57, // 46: problems.ProblemsService.CreateProblem:input_type -> problems.CreateProblemRequest
	58, // 47: problems.ProblemsService.UpdateProblem:input_type -> problems.UpdateProblemRequest
	59, // 48: problems.ProblemsService.DeleteProblem:input_type -> problems.DeleteProblemRequest
	60, // 49: problems.ProblemsService.GetProblem:input_type -> problems.GetProblemRequest
	61, // 50: problems.ProblemsService.ListProblems:input_type -> problems.ListProblemsRequest
	87, // 51: problems.ProblemsService.GetProblemByIDSlug:input_type -> problems.GetProblemByIdSlugRequest
	89, // 52: problems.ProblemsService.GetProblemMetadataList:input_type -> problems.GetProblemMetadataListRequest
	62, // 53: problems.ProblemsService.AddTestCases:input_type -> problems.AddTestCasesRequest
	76, // 54: problems.ProblemsService.DeleteTestCase:input_type -> problems.DeleteTestCaseRequest
	78, // 55: problems.ProblemsService.GetLanguageSupports:input_type -> problems.GetLanguageSupportsRequest
	63, // 56: problems.ProblemsService.AddLanguageSupport:input_type -> problems.AddLanguageSupportRequest
	64, // 57: problems.ProblemsService.UpdateLanguageSupport:input_type -> problems.UpdateLanguageSupportRequest
	65, // 58: problems.ProblemsService.RemoveLanguageSupport:input_type -> problems.RemoveLanguageSupportRequest
	80, // 59: problems.ProblemsService.FullValidationByProblemID:input_type -> problems.FullValidationByProblemIDRequest
	82, // 60: problems.ProblemsService.RunUserCodeProblem:input_type -> problems.RunProblemRequest
	85, // 61: problems.ProblemsService.GetSubmissionsByOptionalProblemID:input_type -> problems.GetSubmissionsRequest
	49, // 62: problems.ProblemsService.GetProblemsDoneStatistics:input_type -> problems.GetProblemsDoneStatisticsRequest
	0,  // 63: problems.ProblemsService.ForceChangeUserEntityInSubmission:input_type -> problems.ForceChangeUserEntityInSubmissionRequest
	43, // 64: problems.ProblemsService.GetMonthlyActivityHeatmap:input_type -> problems.GetMonthlyActivityHeatmapRequest
	34, // 65: problems.ProblemsService.GetTopKGlobal:input_type -> problems.GetTopKGlobalRequest
	36, // 66: problems.ProblemsService.GetTopKEntity:input_type -> problems.GetTopKEntityRequest
	38, // 67: problems.ProblemsService.GetUserRank:input_type -> problems.GetUserRankRequest
	40, // 68: problems.ProblemsService.GetLeaderboardData:input_type -> problems.GetLeaderboardDataRequest
	14, // 69: problems.ProblemsService.CreateChallenge:input_type -> problems.CreateChallengeRequest
	16, // 70: problems.ProblemsService.GetChallengeDetails:input_type -> problems.GetChallengeDetailsRequest
	18, // 71: problems.ProblemsService.GetPublicChallenges:input_type -> problems.GetPublicChallengesRequest
	20, // 72: problems.ProblemsService.JoinChallenge:input_type -> problems.JoinChallengeRequest
	22, // 73: problems.ProblemsService.StartChallenge:input_type -> problems.StartChallengeRequest
	24, // 74: problems.ProblemsService.EndChallenge:input_type -> problems.EndChallengeRequest
	26, // 75: problems.ProblemsService.GetSubmissionStatus:input_type -> problems.GetSubmissionStatusRequest
	28, // 76: problems.ProblemsService.GetChallengeSubmissions:input_type -> problems.GetChallengeSubmissionsRequest
	30, // 77: problems.ProblemsService.GetUserStats:input_type -> problems.GetUserStatsRequest
	32, // 78: problems.ProblemsService.GetChallengeUserStats:input_type -> problems.GetChallengeUserStatsRequest
	5,  // 79: problems.ProblemsService.GetChallengeHistory:input_type -> problems.GetChallengeHistoryRequest
	2,  // 80: problems.ProblemsService.GetBulkProblemMetadata:input_type -> problems.GetBulkProblemMetadataRequest
	67, // 81: problems.ProblemsService.CreateProblem:output_type -> problems.CreateProblemResponse
	68, // 82: problems.ProblemsService.UpdateProblem:output_type -> problems.UpdateProblemResponse
	69, // 83: problems.ProblemsService.DeleteProblem:output_type -> problems.DeleteProblemResponse
	70, // 84: problems.ProblemsService.GetProblem:output_type -> problems.GetProblemResponse
	71, // 85: problems.ProblemsService.ListProblems:output_type -> problems.ListProblemsResponse
	88, // 86: problems.ProblemsService.GetProblemByIDSlug:output_type -> problems.GetProblemByIdSlugResponse
	90, // 87: problems.ProblemsService.GetProblemMetadataList:output_type -> problems.GetProblemMetadataListResponse
	72, // 88: problems.ProblemsService.AddTestCases:output_type -> problems.AddTestCasesResponse
	77, // 89: problems.ProblemsService.DeleteTestCase:output_type -> problems.DeleteTestCaseResponse
	79, // 90: problems.ProblemsService.GetLanguageSupports:output_type -> problems.GetLanguageSupportsResponse
	73, // 91: problems.ProblemsService.AddLanguageSupport:output_type -> problems.AddLanguageSupportResponse
	74, // 92: problems.ProblemsService.UpdateLanguageSupport:output_type -> problems.UpdateLanguageSupportResponse
	75, // 93: problems.ProblemsService.RemoveLanguageSupport:output_type -> problems.RemoveLanguageSupportResponse
	81, // 94: problems.ProblemsService.FullValidationByProblemID:output_type -> problems.FullValidationByProblemIDResponse
	83, // 95: problems.ProblemsService.RunUserCodeProblem:output_type -> problems.RunProblemResponse
	86, // 96: problems.ProblemsService.GetSubmissionsByOptionalProblemID:output_type -> problems.GetSubmissionsResponse
	50, // 97: problems.ProblemsService.GetProblemsDoneStatistics:output_type -> problems.GetProblemsDoneStatisticsResponse
	1,  // 98: problems.ProblemsService.ForceChangeUserEntityInSubmission:output_type -> problems.ForceChangeUserEntityInSubmissionResponse
	45, // 99: problems.ProblemsService.GetMonthlyActivityHeatmap:output_type -> problems.GetMonthlyActivityHeatmapResponse
	35, // 100: problems.ProblemsService.GetTopKGlobal:output_type -> problems.GetTopKGlobalResponse
	37, // 101: problems.ProblemsService.GetTopKEntity:output_type -> problems.GetTopKEntityResponse
	39, // 102: problems.ProblemsService.GetUserRank:output_type -> problems.GetUserRankResponse
	41, // 103: problems.ProblemsService.GetLeaderboardData:output_type -> problems.GetLeaderboardDataResponse
	15, // 104: problems.ProblemsService.CreateChallenge:output_type -> problems.CreateChallengeResponse
	17, // 105: problems.ProblemsService.GetChallengeDetails:output_type -> problems.GetChallengeDetailsResponse
	19, // 106: problems.ProblemsService.GetPublicChallenges:output_type -> problems.GetPublicChallengesResponse
	21, // 107: problems.ProblemsService.JoinChallenge:output_type -> problems.JoinChallengeResponse
	23, // 108: problems.ProblemsService.StartChallenge:output_type -> problems.StartChallengeResponse
	25, // 109: problems.ProblemsService.EndChallenge:output_type -> problems.EndChallengeResponse
	27, // 110: problems.ProblemsService.GetSubmissionStatus:output_type -> problems.GetSubmissionStatusResponse
	29, // 111: problems.ProblemsService.GetChallengeSubmissions:output_type -> problems.GetChallengeSubmissionsResponse
	31, // 112: problems.ProblemsService.GetUserStats:output_type -> problems.GetUserStatsResponse
	33, // 113: problems.ProblemsService.GetChallengeUserStats:output_type -> problems.GetChallengeUserStatsResponse
	6,  // 114: problems.ProblemsService.GetChallengeHistory:output_type -> problems.GetChallengeHistoryResponse
	3,  // 115: problems.ProblemsService.GetBulkProblemMetadata:output_type -> problems.GetBulkProblemMetadataResponse
...
func file_ProblemsService_problemsservice_proto_init() {
	...
	file_ProblemsService_problemsservice_proto_msgTypes[46].OneofWrappers = []any{}
	file_ProblemsService_problemsservice_proto_msgTypes[47].OneofWrappers = []any{}
	file_ProblemsService_problemsservice_proto_msgTypes[48].OneofWrappers = []any{}
	...
	file_ProblemsService_problemsservice_proto_msgTypes[85].OneofWrappers = []any{}
	file_ProblemsService_problemsservice_proto_msgTypes[87].OneofWrappers = []any{}
	type x struct{}
